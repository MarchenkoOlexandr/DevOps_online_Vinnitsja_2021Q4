...
1. Log in to the system as root.
	![Log in to the system as root.](https "Log in to the system as root.")
...
parameters of the command. What system file does it change?
	...
	![passwd - changed password for current user](https2 "passwd - changed password for current user")
	![What system file does it change?](https3 "What system file does it change?")
...
execution?
	...
	![registered users - cat /etc/passwd](https4 "registered users - cat /etc/passwd")
...
4. Change personal information about yourself.
	...
	![Change personal information about yourself.](https5 "Change personal information about yourself.")
...
keys for these commands. Give examples.
	...
	![if we need help we can used command man and help](https6 "if we need help we can used command man and help")
	![if we need help we can used command man and help](https7 "if we need help we can used command man and help")
	![if we need help we can used command man and help](https8 "if we need help we can used command man and help")
	![if we need help we can used command man and help](https9 "if we need help we can used command man and help")
...
of files .bash* using commands.
	...
	![View the contents of files .bash using commands.](https10 "View the contents of files .bash using commands.")
	![View the contents of files .bash using commands.](https11 "View the contents of files .bash using commands.")
	![View the contents of files .bash using commands.](https12 "View the contents of files .bash using commands.")
	![View the contents of files .bash using commands.](https13 "View the contents of files .bash using commands.")
...
read the documentation for the finger command.
	...
	![read the documentation for the finger command](https14 "read the documentation for the finger command")
...
command.
	...
	![List the contents of the home directory using the ls command](https15 "List the contents of the home directory using the ls command")
...
and including the second nesting level.
	...
	![Examine the tree command](https16 "Examine the tree command")
...
binary)? Give an example.
	...
	![file command for Determine type of FILEs.](https17 "file command for Determine type of FILEs.")
	![file command for Determine type of FILEs.](https18 "file command for Determine type of FILEs.")
	
3. Master the skills of navigating the file system using relative and absolute paths.
How can you go back to your home directory from anywhere in the filesystem?

	![relative path I used: cd ~ or cd $home absolute path I used: cd /home/legion](https19 "relative path I used: cd ~ or cd $home absolute path I used: cd /home/legion")
...
the terminal using the -l and -a switches.
	...
	![ls command](https20 "ls command")
	![Explain the information displayed on the terminal using the -l and -a switches = ls -l  use a long listing format  ls -a do not ignore entries starting with .](https21 "Explain the information displayed on the terminal using the -l and -a switches ls -l  use a long listing format  ls -a do not ignore entries starting with .")
	**For solution this task I used command ls -alh --group-directories-first**
	**in this command -a do not ignore entries starting with . + -l use a long listing format + -h human-readable + --group-directories-first  group directories before files**
...
- delete the file copied to the home directory.
	...
	![Perform the following sequence of operations](https22 "Perform the following sequence of operations")
...
- then delete the labwork2. What changes have occurred and why?
	...
	![Perform the following sequence of operations](https24 "Perform the following sequence of operations")
	**mkdir test**
	...
	**less labwork2**
	...
	![nano softlink](https23 "nano softlink")
	![less softlink](https25 "less softlink")	
	![less softlink](https26 "less softlink")
	
	**mv hardlinklabwork2 hard_lnk_labwork2 && softlinklabwork2 symb_lnk_labwork2**
	**rm labwork2**
	
	![result](https27 "result")
	![result](https28 "result")
...
sequence.
	...
	![Using the locate utility](https29 "Using the locate utility")
...
these partitions.
	...
	![Determine which partitions are mounted in the system, as well as the types of these partitions](https30 "Determine which partitions are mounted in the system, as well as the types of these partitions")
	**df**
	
9. Count the number of lines containing a given sequence of characters in a given
file.

	![Count the number of lines containing a given sequence of characters in a given file](https31 "Count the number of lines containing a given sequence of characters in a given file")
...
host character sequence.
	...
	![Using the find command](https32 "Using the find command")
...
duplicate a similar command using a bunch of grep?
	...
	![List all objects in /etc that contain the ss character sequence](https33 "List all objects in /etc that contain the ss character sequence")
...
directory.
	...
	![List the first 5 directory files that were recently accessed in the /etc directory.](https34 "List the first 5 directory files that were recently accessed in the /etc directory.")
